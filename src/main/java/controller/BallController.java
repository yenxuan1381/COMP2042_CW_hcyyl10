...
//
///**
// * This abstract class BallController allows other class to implement its method
// * @author Emily
// *
// */
//
...
//        getPosition().setLocation((getPosition().getX() + speedX),(getPosition().getY() + speedY));
...
//    	int xSpeed = ballModel.getSpeedX();
//        ballModel.setXSpeed(xSpeed *= -1);
//    }
//    
//    /**
...
//        int ySpeed = ballModel.getSpeedY();       
//        ballModel.setYSpeed(ySpeed *= -1);
//    }
//    
//    /**
