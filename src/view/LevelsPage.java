...
public class LevelsPage  extends JComponent implements MouseListener, MouseMotionListener {
	
	private static final String GREETINGS = "Choose Your Level:";
